...
"content": "Skip to content All Democrats in the U.S. Senate voted against the nomination of Attorney General Todd Blanche, but their opposition was overridden by a majority of GOP lawmakers in the upper chambe… [+4733 chars]"
  ...
  async componentDidMount(){
    let url =  `https://newsapi.org/v2/top-headlines?country=us&apiKey=0e92d54a98324fd592561f708246dd55&page=1`;
  ...
  handlePrevClick = async()=>{
    console.log("prev");
    let url =  `https://newsapi.org/v2/top-headlines?country=us&apiKey=0e92d54a98324fd592561f708246dd55&page=${this.state.page-1}`;
    let data = await fetch(url);
    let parsedData = await data.json()
    console.log(parsedData);
    this.setState({
    ...
    return (
      <div className='container' my-3="true">
        ...
        <div className="container d-flex justify-content-center ">
          ...
          <button type="button" className="btn btn-dark mx-3"  onClick={this.handleNextClick}>next</button>
        </div>
